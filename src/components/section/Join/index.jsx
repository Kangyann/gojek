import join_1 from "assets/Images/join_1.svg";
import join_2 from "assets/Images/join_2.svg";
import join_3 from "assets/Images/join_3.svg";

const Benefit = () => {
  const data = [
    {
      title: "Employees",
      description: "Behind Southeast Asia's only hyper-growth startup are some billion-dollar brains, doing what the do best.",
      image: join_1,
          ...
          {data.map((val, idx) => (
            <li className="join__menu__item" key={`hm-${idx}`}>
              ...
              <div className="join__menu__item__text">
                ...
                <a href={val.to} className="button">{val.link}</a>
              </div>
            </li>
          ))}
        </ul>
